...
namespace DotNetHelper.ObjectToSql.Tests.SqlServerTest.Generic.Delete
{
    public class SqlServerGenericDeleteFixtureSqlColumn
    {
        ...
        public void Test_Generic_BuildDeleteQuery_Ensure_MissingKeyException_Is_Thrown_()
        {
            ...
            Assert.That(() => sqlServerObjectToSql.BuildDeleteQuery<EmployeeWithMappedColumnSqlColumn>(StringBuilder, nameof(Employee)),
                Throws.Exception
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildDeleteQuery<EmployeeWithIdentityKeySqlColumn>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildDeleteQuery<EmployeeWithPrimaryKeySqlColumn>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildDeleteQuery<EmployeeWithManyPrimaryKeySqlColumn>(StringBuilder, nameof(Employee));
