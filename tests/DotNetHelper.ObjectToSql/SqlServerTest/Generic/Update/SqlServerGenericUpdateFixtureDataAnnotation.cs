...
namespace DotNetHelper.ObjectToSql.Tests.SqlServerTest.Generic.Update
{
    public class SqlServerGenericUpdateFixtureDataAnnotation
    {
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildUpdateQuery<EmployeeWithIgnorePropertyAndKeyDataAnnotation>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildUpdateQuery<EmployeeWithIdentityKeyDataAnnotation>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildUpdateQuery<EmployeeWithPrimaryKeyDataAnnotation>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildUpdateQuery<EmployeeWithManyPrimaryKeyDataAnnotation>(StringBuilder, nameof(Employee));
        ...
        {
            var sqlServerObjectToSql = new Services.ObjectToSql(DataBaseType.SqlServer);
            sqlServerObjectToSql.BuildUpdateQuery<EmployeeWithPrimaryKeyDataAnnotation>(StringBuilder, nameof(Employee),e => e.FirstName);
